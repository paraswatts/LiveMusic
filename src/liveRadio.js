         ...
         >  
          ...
          contentContainerStyle={{            alignItems: "center"
            ...
            <View style={styles.container}>
              <Text style={{color:'#fff',fontSize:30,fontWeight:'bold'}}>Listen Live Radio</Text>
            </View>
            <TouchableOpacity style={{marginTop:width*0.10 }} activeOpacity={0.5} onPress={() => {                                                                                                   
                if(this.state.networkType == 'none')
                {
                  ...
                  navigate('PlayLiveRadio', { videoId: this.state.videoId })                
                }
          }} >
          <Image 
          style={{width:width*0.6,height:width*0.6}}
          source={{uri:'https://lh3.googleusercontent.com/-lVSk8EvJURM/WgvrIM7tCvI/AAAAAAAAAO0/shiXMJQqvDMsdfixN5pGGOwFiHJKM7P6ACK8BGAs/s256/2017-11-14.png'}}/>
          </TouchableOpacity>
          </ScrollView>
        </ImageBackground>                                      
      );
